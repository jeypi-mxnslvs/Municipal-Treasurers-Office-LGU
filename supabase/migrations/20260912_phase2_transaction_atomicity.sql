...
-- 2. Enhance Properties & Payment Postings Tables for COA Compliance & Partial Quarters
ALTER TABLE public.properties
    ADD COLUMN IF NOT EXISTS last_paid_quarter INT NOT NULL DEFAULT 4;
...
ALTER TABLE public.payment_postings 
    ...
    ADD COLUMN IF NOT EXISTS previous_last_paid_quarter INT,
